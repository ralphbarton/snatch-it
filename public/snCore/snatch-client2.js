...
// replacing snCore.Basic.canv_W
var port_W = undefined;
var port_H = undefined;
...
socket.on('player color choices', function(msg_obj){
    ...
    port_W = window.innerWidth;
    port_H = window.innerHeight;
    ...
    snCore.Splash2.triggerPromptScreen(colorSet, players_t);
});
